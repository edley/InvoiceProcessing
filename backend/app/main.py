...
from app.routers import upload, proofs, erp, receipts, whatsapp, accounting, reconciliation, settings
...
def test_whatsapp():
    ...
    result = whatsapp_client.send_message("31611000862", "Test from AI-Tolmai backend")
    return result
